...
<div class="container">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="champange.jsp">Champange</a>
    <a class="dropdown-item" href="gin.jsp">Gin</a>
       <a class="dropdown-item" href="vodka.jsp">Vodka</a>
       <a class="dropdown-item" href="rum.jsp">Rum</a>
